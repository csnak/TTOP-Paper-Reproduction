...
for (s in YEEERS)  
{
  ...
  # Added line, commented out original line
  fit <- readRDS(paste0(output_folder_2, "fit_obs_model_lineyrs_",s,"_iter",NUM_ITS,".rds"))
...
# Added line (Added plots and output_folder directory)
dir.create("plots", showWarnings = FALSE, recursive = TRUE)

dir.create("new_plots_folder", showWarnings = FALSE, recursive = TRUE)


# ### save beta csv to check for TTOP:
# write_csv(beta_checkAll, paste0("plots/beta_ttop_results_beta_checkAll.csv"))
write_csv(beta_checkAll, paste0("new_plots_folder/beta_ttop_results_beta_checkAll_final.csv"))
...
write_csv(TTOP_proportions, paste0("new_plots_folder/TTOP_proportions_final.csv"))
...
for(sss in YEEERS) # 12:19 # 18:18
{
  ...
  ggsave(paste0("new_plots_folder/beta_boxplot_20",sss,"_final", ".png"), beta_boxplot, width=10, height=5)
  ...
  ggsave(paste0("new_plots_folder/plot_obs_results_20", sss, "_xwoba_check_final", ".png"),
         xwoba_check_plot, width=8, height=5)
  ...
  ggsave(paste0("new_plots_folder/plot_obs_results_20", sss, "_xwoba_check_1_final", ".png"),
         xwoba_check_plot_1, width=8, height=5)
}
...
ggsave(paste0("new_plots_folder/plot_obs_results", "_xwoba_check_ALLYR_final", ".png"),
       xwoba_check_plot_ALLYRS, width=15, height=6)
...
ggsave(paste0("new_plots_folder/plot_obs_results", "_xwoba_check_ALLYRS_1_final", ".png"),
       xwoba_check_plot_ALLYRS_1, width=15, height=6)
...
ggsave(paste0("new_plots_folder/beta_boxplot_ALLYRS_final.png"), beta_boxplot_ALLYRS, width=18, height=8)
