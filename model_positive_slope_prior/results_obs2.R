...
# Added line to get NUM_ITS variable for model naming
source("A_importRstan.R")
...
# Added line
fit <- readRDS(paste0(output_folder_2, "fit_obs_model_lineyrs_",YRS-2000,"_iter",NUM_ITS,".rds"))
...
# Added lines
ggsave(paste0("new_plots_folder/tto_p_diff_12.png"), plot_probs_avgTTOdiff12, width=10, height=6)
ggsave(paste0("new_plots_folder/tto_p_diff_23.png"), plot_probs_avgTTOdiff23, width=10, height=6)
ggsave(paste0("new_plots_folder/tto_xw_diff_12.png"), plot_xw_avgTTOdiff12, width=10, height=4)
ggsave(paste0("new_plots_folder/tto_xw_diff_23.png"), plot_xw_avgTTOdiff23, width=10, height=4)
...
# Added lines
ggsave(paste0("new_plots_folder/tto_xwoba_diff_12.png"), plot_xwoba_avgTTOdiff12, width=5, height=4)
ggsave(paste0("new_plots_folder/tto_xwoba_diff_23.png"), plot_xwoba_avgTTOdiff23, width=5, height=4)
...
# Added line
write_csv(data.frame(hh_results), "new_plots_folder/hand_home_results.csv")
...
# Added line
write_csv(data.frame(bqpq_results), "new_plots_folder/bq_pq_results.csv")
