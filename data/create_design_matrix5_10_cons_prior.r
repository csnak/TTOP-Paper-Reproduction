...
# Added new output file name, commented out line is original
output_filename = "TTO_dataset_510_cons.csv"
...
get_PQ <- function(E00, nu=nu, tau=TAU) {
  ...
  ########### theta_bar_0 for pitchers ########### 
  {
    ...
    # theta_bar_0 (Added a flat prior, commented out line is original)
    pit_szns2 = pit_szns1 %>% 
      mutate(pit_played_in_prev_szn = !is.na(prev_szn_avg_woba),
            theta_bar_0_pit = prev_szn_avg_woba_allPit)
